...
public class JedisAdapter extends Jedis {
    ...
    public Long persist(final String key) {
        try {
            return redis.persist(key) ? 1L : 0L;
        } catch (Exception e) {
            throw new JedisException(e);
        }
    }
    ...
    public Set<String> zrangeByScore(final String key, final double min, final double max,
        ...
        try {
            return ZsetPair.members(
                    redis.zrangebyscore(key, String.valueOf(min), String.valueOf(max), "limit", String.valueOf(offset),
    ...
    public Set<String> zrangeByScore(final String key, final String min, final String max,
        ...
        try {
            return ZsetPair.members(
                    redis.zrangebyscore(key, min, max, "limit", String.valueOf(offset), String.valueOf(count)));
        } catch (Exception e) {
            throw new JedisException(e);
        }
    }
    ...
    public Set<Tuple> zrangeByScoreWithScores(final String key, final String min, final String max,
            final int offset, final int count) {
        try {
            return toTupleSet(redis.zrangebyscore(key, min, max, "limit", String.valueOf(offset), String.valueOf(count),
                    "withscores"));
        } catch (Exception e) {
            throw new JedisException(e);
        }
    ...
    public Set<String> zrevrangeByScore(final String key, final double max, final double min,
            final int offset, final int count) {
        try {
            return ZsetPair.members(redis.zrevrangebyscore(key, String.valueOf(max), String.valueOf(min), "limit",
    ...
    public Set<Tuple> zrevrangeByScoreWithScores(final String key, final double max,
        ...
        try {
            return toTupleSet(redis.zrevrangebyscore(key, String.valueOf(max), String.valueOf(min), "limit",
                    String.valueOf(offset), String.valueOf(count), "withscores"));
        } catch (Exception e) {
            throw new JedisException(e);
        }
    }
    ...
    public Set<Tuple> zrevrangeByScoreWithScores(final String key, final String max,
        ...
        try {
            return toTupleSet(
                    redis.zrevrangebyscore(key, max, min, "limit", String.valueOf(offset), String.valueOf(count),
                            "withscores"));
        } catch (Exception e) {
            throw new JedisException(e);
        }
    ...
    public String set(final byte[] key, final byte[] value) {
        // Note: In the background Redis stores String as byte[].
        // This does the inverse (stores byte[] as String) for mocking purposes...
        try {
    ...
    public byte[] get(final byte[] key) {
        try {
            return redis.get(SafeEncoder.encode(key)).getBytes();
        } catch (Exception e) {
            throw new JedisException(e);
        }
    }
