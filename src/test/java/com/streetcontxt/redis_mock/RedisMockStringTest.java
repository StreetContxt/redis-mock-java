...
public class RedisMockStringTest {
    ...
    @Test public void bitcountShouldReturnTheBitcountOfAKey() throws WrongTypeException,
    ...
    @Test public void bitcountShouldReturnTheBitcountOfAKeyInARange() throws WrongTypeException,
            SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
        String v0 = "000", v1 = "111", v2 = "34?";
    ...
    @Test public void bitopShouldReturnZeroIfNoneOfTheKeysExist() throws WrongTypeException,
            SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String dk = "dk", k1 = "k1", k2 = "k2";
        String v = "value";
    ...
    @Test public void bitopShouldDoAnANDOperationAgainstStringsStoreTheResultAndReturnTheStringLength() throws WrongTypeException,
            SyntaxErrorException {
        RedisMock redis = new RedisMock();
    ...
    @Test public void bitopShouldDoAnOROperationAgainstStringsStoreTheResultAndReturnTheStringLength() throws WrongTypeException,
            SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String dk = "dk", k1 = "k1", k2 = "k2", k3 = "k3";
        String v1 = "111", v2 = "222", v3 = "333";
    ...
    @Test public void bitopShouldDoAnXOROperationAgainstStringsStoreTheResultAndReturnTheStringLength() throws WrongTypeException,
            SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String dk = "dk", k1 = "k1", k2 = "k2", k3 = "k3";
        String v1 = "111", v2 = "222", v3 = "333";
    ...
    @Test public void bitopShouldDoANOTOperationAgainstStringsStoreTheResultAndReturnTheStringLength() throws WrongTypeException,
            SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String dk = "dk", k1 = "k1";
    ...
    @Test public void bitposShouldReturnNegOneForKeyThatDoesNotExistAndSetBitIsSpecified() throws WrongTypeException,
            BitArgException {
        RedisMock redis = new RedisMock();
        String k = "key";
        String v = "value";
    ...
    @Test public void bitposShouldReturnZeroForKeyThatDoesNotExistAndClearBitIsSpecified() throws WrongTypeException,
            BitArgException {
        RedisMock redis = new RedisMock();
        String k = "key";
        String v = "value";
    ...
    @Test public void bitposShouldReturnOffTheEndForKeyThatIsAllOnesAndClearBitSpecified() throws WrongTypeException,
            BitArgException, SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
        String v = "";
        v += (char)(0xFF);
    ...
    @Test public void bitposShouldReturnNegOneForKeyThatIsAllZeroesAndSetBitSpecified() throws WrongTypeException,
            BitArgException, SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
        String v = "\0\0";
    ...
    @Test public void bitposShouldReturnOffTheEndForKeyThatIsAllOnesClearBitSpecifiedAndOnlyStartSpecified() throws WrongTypeException,
            BitArgException, SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
        String v = "";
    ...
    @Test public void bitposShouldReturnNegOneForKeyThatIsAllOnesClearBitSpecifiedAndStartAndEndBothSpecified() throws WrongTypeException,
            BitArgException, SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
        String v = "";
    ...
    @Test public void bitposShouldReturnNegOneForKeyThatIsAllZeroesSetBitIsSpecifiedAndStartIsSpecified() throws WrongTypeException,
            BitArgException, SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
        String v = "\0\0\0";
    ...
    @Test public void bitposShouldReturnNegOneForKeyThatIsAllZeroesSetBitSpecifiedAndStartAndEndBothSpecified() throws WrongTypeException,
            BitArgException, SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
        String v = "\0\0\0\0";
    ...
    @Test public void bitposShouldReturnFirstZeroPosForKeyWithClearBitSpecified() throws WrongTypeException,
            BitArgException, SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
        String v = "";
    ...
    @Test public void bitposShouldReturnFirstZeroPosForKeyWithClearBitSpecifiedFromStart() throws WrongTypeException,
            BitArgException, SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
        String v = "";
    ...
    @Test public void bitposShouldReturnFirstZeroPosForKeyWithClearBitSpecifiedBetweenStartAndEnd() throws WrongTypeException,
            BitArgException, SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
        String v = "";
    ...
    @Test public void bitposShouldReturnFirstOnePosForKeyWithSetBitSpecified() throws WrongTypeException,
            BitArgException, SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
        String v = "\0";
    ...
    @Test public void bitposShouldReturnFirstOnePosForKeyWithSetBitSpecifiedFromStart() throws WrongTypeException,
            BitArgException, SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
        String v = "\0\0\0";
    ...
    @Test public void bitposShouldReturnFirstOnePosForKeyWithSetBitSepcifiedBetweenStartAndEnd() throws WrongTypeException,
            BitArgException, SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
        String v = "\0\0\0";
    ...
    @Test public void decrShouldThrowAnErrorForKeyThatIsNotAString() throws WrongTypeException,
            NotIntegerException, SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
        String v = "value";
        redis.lpush(k, v);
    ...
    @Test public void decrShouldThrowAnErrorForKeyThatIsNotANumber() throws WrongTypeException,
            NotIntegerException, SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
        String v = "value";
    ...
    @Test public void decrShouldInitKeyWithZeroIfKeyDoesNotExistThenDecr() throws WrongTypeException,
            NotIntegerException, SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
    ...
    @Test public void decrShouldDecrANumberKeyBy1() throws WrongTypeException, NotIntegerException,
            SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
        long v = 123L;
    ...
    @Test public void decrbyShouldThrowAnErrorIfKeyIsNotANumber() throws WrongTypeException,
            SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
        String v = "value";
    ...
    @Test public void decrbyShouldInitKeyWithZeroIfItDoesNotExistThenDecrby() throws WrongTypeException,
            NotIntegerException, SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
    ...
    @Test public void decrbyShouldDecrbyANumberByTheDecrement() throws WrongTypeException,
            NotIntegerException, SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
        long v = 123L;
    ...
    @Test public void getShouldReturnTheValueForAnExistingKey() throws WrongTypeException,
            SyntaxErrorException {
        RedisMock redis = new RedisMock();
        redis.set("key", "value");
    ...
    @Test public void getbitShouldReturnZeroForAnOutOfBoundsOffset() throws WrongTypeException,
            SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
        String v = "value";
    ...
    @Test public void getbitShouldReturnTheBitAtTheOffset() throws WrongTypeException,
            SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
        String v = "12?";
    ...
    @Test public void getrangeShouldReturnAnEmptyStringForOutOfRangePositiveIndices() throws WrongTypeException,
            SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
        String v = "value";
    ...
    @Test public void getrangeShouldReturnAnEmptyStringForOutOfRangeNegativeIndices() throws WrongTypeException,
            SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
        String v = "value";
    ...
    @Ignore("not ready yet") public void getrangeShouldReturnAnEmptyStringForOutOfRangeMixedIndices() throws WrongTypeException,
            SyntaxErrorException {
    }

    @Test public void getrangeShouldReturnRangeForInRangePositiveIndices() throws WrongTypeException,
            SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
        String v = "value";
    ...
    @Test public void getrangeShouldReturnRangeForInRangeNegativeIndices() throws WrongTypeException,
            SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
        String v = "value";
    ...
    @Test public void getrangeShouldReturnRangeForInRangeMixedIndices() throws WrongTypeException,
            SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
        String v = "value";
    ...
    @Test public void getsetShouldReturnThePreviousValueForAnExistingKey() throws WrongTypeException,
            SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
    ...
    @Test public void incrShouldThrowAnErrorIfKeyIsNotAnInteger() throws WrongTypeException,
            SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
        String v = "value";
    ...
    @Test public void incrShouldInitializeKeyWithZeroIfItDoesNotExistThenIncr() throws WrongTypeException,
            NotIntegerException {
        RedisMock redis = new RedisMock();
        String k = "key";
    ...
    @Test public void incrShouldIncrAnIntegerKeyByOne() throws WrongTypeException, NotIntegerException,
            SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
        long v = 123L;
    ...
    @Test public void incrbyShouldThrowAnErrorIfKeyIsNotAnInteger() throws WrongTypeException,
            SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
        String v = "value";
    ...
    @Test public void incrbyShouldInitKeyToZeroAndThenIncrbyIfItDoesNotExist() throws WrongTypeException,
            NotIntegerException {
        RedisMock redis = new RedisMock();
        String k = "key";
    ...
    @Test public void incrbyShouldIncrAnIntegerKeyByIncrement() throws WrongTypeException,
            NotIntegerException, SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
        long v = 123L;
    ...
    @Test public void incrbyfloatShouldThrowAnErrorIfKeyIsNotANumber() throws WrongTypeException,
            SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
        String v = "value";
    ...
    @Test public void incrbyfloatShouldInitKeyWithZeroThenIncrbyfloatIfItDoesNotExist() throws WrongTypeException,
            NotFloatException {
        RedisMock redis = new RedisMock();
        String k = "key";
    ...
    @Test public void msetnxShouldNotSetAnyKeyIfAtLeastOneKeyExists() throws WrongTypeException,
            ArgException {
        RedisMock redis = new RedisMock();
        String k1 = "key1", k2 = "key2", k3 = "key3";
        String v1 = "value1", v2 = "value2", v3 = "value3";
    ...
    @Test public void psetexShouldSetAndExpireKeyInMilliseconds() throws WrongTypeException,
            SyntaxErrorException, InterruptedException {
        RedisMock redis = new RedisMock();
        String k = "key";
        String v = "value";
    ...
    @Test public void setShouldSetAKeyToAStringValue() throws WrongTypeException,
            SyntaxErrorException {
        RedisMock redis = new RedisMock();
    ...
    @Test public void setShouldOverridePreviousMapping() throws WrongTypeException,
            SyntaxErrorException {
        RedisMock redis = new RedisMock();
        redis.set("key", "v1");
    ...
    @Test public void setShouldNotSetIfKeyExistsAndNxGiven() throws WrongTypeException,
            SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String key = "key";
        String v1 = "v1", v2 = "v2";
    ...
    @Test public void setShouldSetIfKeyDoesNotExistAndNxGiven() throws WrongTypeException,
            SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String key = "key";
        String v1 = "v1";
    ...
    @Test public void setShouldNotSetIfKeyDoesNotExistAndXxGiven() throws WrongTypeException,
            SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String key = "key";
        String v1 = "v1";
    ...
    @Test public void setShouldSetIfKeyDoesExistAndXxGiven() throws WrongTypeException,
            SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String key = "key";
        String v1 = "v1", v2 = "v2";
    ...
    @Test public void setShouldSetAndExpireKeyInSecondsIfExGiven() throws WrongTypeException,
            SyntaxErrorException, InterruptedException {
        RedisMock redis = new RedisMock();
        String k = "key";
        String v = "value";
    ...
    @Test public void setShouldSetAndExpireKeyInMillisecondsIfPxGiven() throws WrongTypeException,
            SyntaxErrorException, InterruptedException {
        RedisMock redis = new RedisMock();
        String k = "key";
        String v = "value";
    ...
    @Test public void setbitShouldClearTheBitAtOffset() throws WrongTypeException,
            SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
        String v = "";
    ...
    @Test public void setbitShouldPadTheStringOutThenSetTheBitAtOffset() throws WrongTypeException,
            SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
        String v = "\0";
    ...
    @Test public void setbitShouldPadTheStringOutThenClearTheBitAtOffset() throws WrongTypeException,
            SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
        String v = "";
    ...
    @Test public void setnxShouldNotSetKeyIfItExists() throws WrongTypeException,
            SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
        String v = "value";
    ...
    @Test public void setrangeShouldSubstituteTheValueAtOffsetWithinLengthOfKey() throws WrongTypeException,
            SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
        String v = "value";
    ...
    @Test public void setrangeShouldZeroPadKeyForOffsetOutsideKeyLength() throws WrongTypeException,
            SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
        String v = "value";
    ...
    @Test public void strlenShouldReturnStringLength() throws WrongTypeException,
            SyntaxErrorException {
        RedisMock redis = new RedisMock();
        String k = "key";
        String v = "value";
